...
class PortfolioContractTests(unittest.TestCase):
    ...
    def test_robustness_config_has_evaluation_contract(self):
        config = (ROOT / "configs/robustness.yaml").read_text(encoding="utf-8")
        for needle in ["seed:", "model:", "evaluation:", "corruption_types:", "severity_levels:"]:
